    ...
    while True:
        ...
        try:
            ...
            if motion == "forward":
                ...
                pid_left = PID(kp_lin_left, ki_lin_left, kd_lin_left, setpoint=left_disp, output_limits=(0.395,0.535), starting_output=linear_speed+0.1*linear_speed)
                while (left_encoder.value < abs(left_disp) - linear_tolerance) and (right_encoder.value < abs(right_disp) - linear_tolerance):
                    ...
                    if counter < 50:
                        right_speed = linear_speed - 0.22*linear_speed
                        counter += 1
                    elif counter < 90:
