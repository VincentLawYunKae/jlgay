...
def handle_mode1():
    ...
    while True:
        ...
        try:
            ...
            if motion == "forward":
                pid_left = PID(kp_lin, ki_lin, kd_lin, setpoint=right_encoder.value, output_limits=(0,0.65), starting_output=linear_speed)
                pid_right = PID(kp_lin, ki_lin, kd_lin, setpoint=left_encoder.value, output_limits=(0,0.65), starting_output=linear_speed)
