...
def handle_mode1():
    ...
    while True:
        ...
        try:
            ...
            if motion == "forward":
                # pid_left = PID(kp_lin, ki_lin, kd_lin, setpoint=left_disp, output_limits=(0.48,0.50), starting_output=linear_speed)
                pid_right =  PID(kp_lin, ki_lin, kd_lin, setpoint=right_disp, output_limits=(0.35,0.75), starting_output=linear_speed)
