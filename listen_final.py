...
def handle_mode1():
    ...
    while True:
        ...
        try:
            ...
            if motion == "forward":
                pid_left = PID(kp_lin, ki_lin, kd_lin, setpoint=right_encoder.value, output_limits=(-0.8,0.8), starting_output=linear_speed)
                pid_right = PID(kp_lin, ki_lin, kd_lin, setpoint=left_encoder.value, output_limits=(-0.8,0.8), starting_output=linear_speed)
