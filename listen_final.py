    ...
    while True:
        ...
        try:
            ...
            if motion == "forward":
                ...
                pid_right =  PID(kp_lin, ki_lin, kd_lin, setpoint=right_disp, output_limits=(0.46,0.51), starting_output=linear_speed-0.1*linear_speed)
                ...
                pid_left = PID(kp_turn, ki_turn, kd_turn, setpoint=set_point, output_limits=(0.61,0.69), starting_output=turn_speed)
                pid_right = PID(kp_turn, ki_turn, kd_turn, setpoint=set_point, output_limits=(0.61,0.69), starting_output=turn_speed)
